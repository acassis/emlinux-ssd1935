...
static unsigned short time_counter = 0;
/* NOTE: Stardate 10505.16 Max Yin
	It's very strange that, MacOS X Tiger's bootpd
	only accept DHCP requests with this option larger
	than 3(?)
*/
// Stardate 10711.13, Max Yin: move this counter from packet.c to here
int send_discover(uint32_t xid, uint32_t requested)
{
	...
	packet.secs = htons(time_counter ++);
