...
#endif
	/* Stardate 10508.25 Max Yin
		Well, on Cirrus EP93xx platform, it seems that Lirc cannot get fast enough
		to decoder IR signal, cause remote command lost.
		Negtive increase nice value to allow Lirc has more priority to do its job.
	 */
	{
		//nice(-20);
