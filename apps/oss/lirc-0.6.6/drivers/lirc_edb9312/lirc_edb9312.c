//*****************************************************************************
//
// lirc_edb9312.c - Driver that records pulse- and pause-lengths
//                  (space-lengths) between GPIO events on the consumer IR
//                  receiver on the EDB9312 board.
//
...
#define LIRC_DRIVER_NAME "lirc_edb9312"
...
MODULE_DESCRIPTION("Infra-red receiver driver for the EDB9312.");
MODULE_LICENSE("GPL");
