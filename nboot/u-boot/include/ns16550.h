...
struct NS16550 {
	unsigned long rbr;		/* 0 rw */
	unsigned long thr;		/* 1 rw */
	unsigned long ier;		/* 2 rw */
	unsigned long iir;		/* 3 rw */
	unsigned long fcr;		/* 4 rw */
	unsigned long lcr;		/* 5 rw */
	unsigned long mcr;		/* 6 rw */
	unsigned long lsr;		/* 7 rw */
	unsigned long msr;		/* 8 rw */
	unsigned long dll;		/* 9 rw */
	unsigned long dlm;		/* 10 rw */
}; /* No need to pack an already aligned struct */
#elif (CFG_NS16550_REG_SIZE == 1)
struct NS16550 {
	unsigned char rbr;		/* 0 */
	unsigned char ier;		/* 1 */
	unsigned char fcr;		/* 2 */
