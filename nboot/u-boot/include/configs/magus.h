...
#define CONFIG_COMMANDS \
	((CONFIG_CMD_DFL & ~(CFG_CMD_AUTOSCRIPT | CFG_CMD_IMLS | CFG_CMD_FLASH)) \
	| CFG_CMD_PING \
	| CFG_CMD_REGINFO)
...
#define CONFIG_BOOTARGS		"root=/dev/nfs nfsroot=192.168.22.16:/home/sasin/gnu/bld/sh/rd mem=64M console=ttyS0,115200n8"
#define CONFIG_BOOTFILE		"uImage"
#define CFG_LOAD_ADDR		0x8C007FC0	/* default load address */
#define CONFIG_SERVERIP		192.168.22.16
...
#define PHYS_SDRAM_1		0x8C000000	/* SDRAM  on CSD0		*/
...
#define CFG_ENV_ADDR		0x8CF30000
