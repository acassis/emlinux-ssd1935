...
int sdr_cfg (uint32_t base, sdr_cfg_t *cfg)
{
	uint32_t w;
...
void sdr_power_up (uint32_t base)
{
	sdr_t	*sdr = (sdr_t *) base;
...
int sdr_start (uint32_t base, sdr_cfg_t *cfg)
{
	sdr_t	*sdr = (sdr_t *) base;
	uint32_t	bl = 0;
