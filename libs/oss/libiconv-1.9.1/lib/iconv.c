 ...
 * Converters.
 */
#if 0 /* by Max Yin, use emlx_converters.h*/
#include "converters.h"
#else
#include "emlx_converters.h"
#endif
...
#define DEFENCODING(xxx_names,xxx,xxx_ifuncs1,xxx_ifuncs2,xxx_ofuncs1,xxx_ofuncs2) \
  ei_##xxx ,
#if 0 /*by Max Yin, use emlx_encondings.def*/
#include "encodings.def"
#else
#include "emlx_encodings.def"
#endif
#ifdef USE_AIX
...
#if 0 /* by Max Yin, use emlx_encodings.def*/
#include "encodings.def"
#else
#include "emlx_encodings.def"
#endif
