...
// 2005.03.31 Sky modify : just don't care about the largefile source support, verify it later
#if 0
...
// 2005.04.25 Sky mark off : we don't support floating point in our mips platform
#if 0
