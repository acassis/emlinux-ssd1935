...
/*  Modified :                                                          */
/* ======================================================================== */
OSCL_EXPORT_REF PVWavParserReturnCode PV_Wav_Parser::InitWavParser(OSCL_wString& aClip, Oscl_FileServer* aFileSession, OsclFileHandle* aFileHandle)
{
    //buffer
    uint8 iBuffer[36];
    ...
    //set the file handle
    ipWAVFile->SetFileHandle(aFileHandle);
