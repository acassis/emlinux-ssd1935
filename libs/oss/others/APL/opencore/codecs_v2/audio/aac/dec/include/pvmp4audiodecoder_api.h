...
#define PVMP4AUDIODECODER_INBUFSIZE  1536
...
#endif
    {
        ...
        */
        ...
        /*
		* parse aac raw frame only or do the decode frame also
		*/
        bool	enableDec;
	...
	// 2010.02.10 :
	// set sbr presentflag in the middle of playback
	...
	// get sample rate that pv decoder consider it as
