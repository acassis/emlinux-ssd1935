...
const UInt32 inverseQuantTable[] =
{
	...
	// 2010.01.11 :
	// from 1025 to 2047 are mapped to 0
	// some corrupted file may cuase the
	// decoding enter absX > 1024, we need
	// to map it to 0 if absX > 1024
