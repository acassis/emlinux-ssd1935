...
// 2009.12.28 :
// if ext sbr data is presented, return 1
// otherwise, return 0
int get_sbr_bitstream(SBRBITSTREAM *sbrBitStream, BITS *pInputStream)
//
{
    /*----------------------------------------------------------------------------
...
//
    ...
    {
		// 2009.12.28 :
		// extra sbr data presents
		// enable the flag
		sbrPresentFlag = 1;
		//
///		printf("%s(): SBR_EXTENSION/SBR_EXTENSION_CRC\n", __FUNCTION__);
