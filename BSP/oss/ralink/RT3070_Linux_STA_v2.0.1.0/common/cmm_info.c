	...
	IN	OID_SET_HT_PHYMODE *pHTPhyMode)
{
	...
	if(IS_RT30xx(pAd) && ((pAd->RfIcType == RFIC_3020) || (pAd->RfIcType == RFIC_2020)))
	{
...
#undef LINE_LEN
#define	LINE_LEN	(4+33+20+8+10+9+7+3+4)	// Channel+SSID+Bssid+WepStatus+AuthMode+Signal+WiressMode+NetworkType+WPS
