...
// end johnli
...
#ifdef CONFIG_STA_SUPPORT
				case CMDTHREAD_802_11_SET_STA_CONFIG:
					{
						RT_802_11_STA_CONFIG *pStaConfig = (RT_802_11_STA_CONFIG *)pData;
						if (pStaConfig->EnableTxBurst != pAd->CommonCfg.bEnableTxBurst)
						{
							pAd->CommonCfg.bEnableTxBurst = (pStaConfig->EnableTxBurst == 1);
						...
						//pAd->CommonCfg.bUseShortSlotTime = pStaConfig->UseShortSlotTime;
						...
						if (MONITOR_ON(pAd))
						{
							...
							RTUSBWriteMACRegister(pAd, RX_FILTR_CFG, 0x0);
							...
							if ((pStaConfig->Rsv1&0x2) == 2)
							{
								...
								DBGPRINT(RT_DEBUG_TRACE, ("BW_40 \n"));
							}
							else
							{
								// 40MHz
								RTUSBReadBBPRegister(pAd, 4, &bbpValue);
								bbpValue &= (~0x18);
								RTUSBWriteBBPRegister(pAd, 4, bbpValue);
								pAd->CommonCfg.BBPCurrentBW = BW_20;
								DBGPRINT(RT_DEBUG_TRACE, ("BW_20 \n"));
							}
						
							DBGPRINT(RT_DEBUG_TRACE, ("CmdThread::CMDTHREAD_802_11_SET_STA_CONFIG (0x1004 = 0x%x\n",Value));
						...
						DBGPRINT(RT_DEBUG_TRACE, ("CmdThread::CMDTHREAD_802_11_SET_STA_CONFIG (Burst=%ld,BGprot=%ld,ShortSlot=%ld,Adhoc=%ld,Protection=%ld\n",
				...
				case OID_802_11_CONFIGURATION:
					if (MONITOR_ON(pAd))
					{
						...
						DBGPRINT_RAW(RT_DEBUG_ERROR, ("( switch channel = %d)\n", pAd->CommonCfg.Channel));
					}
					break;
					
				case CMDTHREAD_SET_PSM_BIT_SAVE:
...
#ifdef CONFIG_STA_SUPPORT
				case CMDTHREAD_LINK_DOWN:                                                                                                                              
					DBGPRINT_RAW(RT_DEBUG_TRACE, ("LinkDown(CMDTHREAD_LINK_DOWN)\n"));                                                                                   
					LinkDown(pAd, TRUE);                                                                                                                            
					break;                                                                                                                                              
#endif // CONFIG_STA_SUPPORT //
				...
				case RT_OID_802_11_RSSI_1:
					{
						...
						NdisMoveMemory(pData, &ulInfo, sizeof(UINT32));
						DBGPRINT(RT_DEBUG_TRACE, ("CmdThread::RT_OID_802_11_RSSI_1(=%d)\n", ulInfo));
#endif // CONFIG_STA_SUPPORT //
					}
				...
				case RT_OID_802_11_RSSI_2:
					{
						...
						NdisMoveMemory(pData, &ulInfo, sizeof(UINT32));
						DBGPRINT(RT_DEBUG_INFO, ("CmdThread::RT_OID_802_11_RSSI_2(=%d)\n", ulInfo));
#endif // CONFIG_STA_SUPPORT //
					}
					break;
