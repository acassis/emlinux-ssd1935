...
#define BULKAGGRE_ZISE          20/*100*/
#define RT28XX_PUT_DEVICE							usb_put_dev
#define RTUSB_ALLOC_URB(iso)							usb_alloc_urb(iso, GFP_KERNEL/*ATOMIC*/)
#define RTUSB_SUBMIT_URB(pUrb)							usb_submit_urb(pUrb, GFP_KERNEL/*ATOMIC*/)
#define RTUSB_URB_ALLOC_BUFFER(pUsb_Dev, BufSize, pDma_addr)			usb_buffer_alloc(pUsb_Dev, BufSize, GFP_KERNEL/*ATOMIC*/, pDma_addr)
...
#define CONTROL_TIMEOUT_JIFFIES ( (500 * OS_HZ) / 1000)
