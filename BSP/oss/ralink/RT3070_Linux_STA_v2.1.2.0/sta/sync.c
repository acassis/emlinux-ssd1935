	...
	IN MLME_QUEUE_ELEM *Elem) 
{
								...
								pVIE)) 
	{
		...
		/*
		Ssid[SsidLen] = '\0';
		printk("%s() : Bssid: %02x:%02x:%02x:%02x:%02x:%02x SSID: %s\n", __FUNCTION__,
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
								...
								pVIE)) 
	{
		...
		{
			/*
			printk("%s(): pAd->MlmeAux.Bssid and Bssid are equal: 0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x\n",
			__FUNCTION__,
			Bssid[0],Bssid[1],Bssid[2],Bssid[3],Bssid[4],Bssid[5]);
			*/
		...
		/*
			...
			printk("%s(): pAd->MlmeAux.Bssid and Bssid are not equal:\n",
			__FUNCTION__);
			printk("      pAd->MlmeAux.Bssid: 0x%02x:0x%02x:0x%02x:0x%02x:0x%02x:0x%02x\n",
	...
	//printk("%s(): sanity check fail, ignore this frame\n", __FUNCTION__);
	}*/
}
