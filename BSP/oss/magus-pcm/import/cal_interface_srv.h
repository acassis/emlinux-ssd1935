...
typedef enum
{
	CAL_MSG_VID_SKPFRAME_SKIPFRAME_NONE = 0,
	CAL_MSG_VID_SKPFRAME_SKIPFRAME_I = 1,
	CAL_MSG_VID_SKPFRAME_SKIPFRAME_IDR = 2,
	CAL_MSG_VID_SKPFRAME_SKIPFRAME_NEXT = 3,
}CAL_MSG_VID_SKIP_FRAME_ENUM;
